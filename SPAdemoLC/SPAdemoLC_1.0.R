...
plot(ax.japan.female.mort,main="",xlab="Age",ylab="ax",type="l",col="green",lwd=3,ylim=c(-9,0))
dev.new()
plot(bx.japan.female.mort,main="",xlab="Age",ylab="bx",type="l",col="red",lwd=3,ylim=c(0,0.025))
dev.new()
plot(kt.japan.female.mort,main="",xlab="Year",ylab="kt",type="l",col="blue",lwd=3,ylim=c(-100,150))
dev.new()
plot(japan.lca.female,main="LC Model: Japan female Mortality")
dev.new()
plot(japan3,series="female",ylim=c(-12,2),main="",col="grey")
...
dev.new()
plot(ax.japan.male.mort,main="",xlab="Age",ylab="ax",type="l",col="green",lwd=3,ylim=c(-9,0))
dev.new()
plot(bx.japan.male.mort,main="",xlab="Age",ylab="bx",type="l",col="red",lwd=3,ylim=c(0,0.025))
dev.new()
plot(kt.japan.male.mort,main="",xlab="Year",ylab="kt",type="l",col="blue",lwd=3,ylim=c(-100,150))
dev.new()
...
dev.new()
plot(ax.taiwan.female.mort,main="",xlab="Age",ylab="ax",type="l",col="green",lwd=3,ylim=c(-9,0))
dev.new()
plot(bx.taiwan.female.mort,main="",xlab="Age",ylab="bx",type="l",col="red",lwd=3,ylim=c(0,0.03))
dev.new()
plot(kt.taiwan.female.mort,main="",xlab="Year",ylab="kt",type="l",col="blue",lwd=3,ylim=c(-50,40))
dev.new()
plot(taiwan.lca.female,main="LC Model: taiwan female Mortality")
dev.new()
plot(taiwan3,series="female",ylim=c(-12,2),main="",col="grey")
...
dev.new()
plot(ax.taiwan.male.mort,main="",xlab="Age",ylab="ax",type="l",col="green",lwd=3,ylim=c(-9,0))
dev.new()
plot(bx.taiwan.male.mort,main="",xlab="Age",ylab="bx",type="l",col="red",lwd=3,ylim=c(0,0.03))
dev.new()
plot(kt.taiwan.male.mort,main="",xlab="Year",ylab="kt",type="l",col="blue",lwd=3,ylim=c(-50,40))
dev.new()
plot(taiwan.lca.male,main="LC Model: taiwan male Mortality")
dev.new()
plot(taiwan3,series="male",ylim=c(-12,2),main="",col="grey")
