...
plot(df$x, df$y, ,ylim=c(-12,2),main="",ylab="Log death rate",xlab="Age", type = "l",mar=c(5, 5, 2, 2),cex.axis = 1.5, cex.lab = 1.7)
...
for (i in 1:20){ 
  df = data.frame(x = 0:100,y =log(japan.mort.female.fcast.test6$rate$female[,i]),
                  l = log(japan.mort.female.fcast.test6$rate$lower[,i]),
                  u = log(japan.mort.female.fcast.test6$rate$upper[,i]))
  plot(df$x, df$y, ,ylim=c(-12,2),main=substitute(paste(b,' (',a,"-step)"),list(a=i,b=1989+i)),ylab="Log death rate",xlab="Age", type = "l")
  polygon(c(df$x,rev(df$x)),c(df$l,rev(df$u)),col = "yellow", border = FALSE)
  lines(df$x, df$y, lwd = 2)
  lines(df$x, df$u, col = "blue",lty=2)
  lines(df$x, df$l, col = "blue",lty=2)
...
japan.fert1 = read.demogdata("JPNasfrRR.txt","JPNexposRR.txt",type="fertility",label="Japan")
...
plot(japan.fert1,series="female",ylim=c(0,0.30),main="",col="grey")
...
df[is.na(df)]     = 0
plot(df$x, df$y, ,ylim=c(0,0.50),main="",ylab="Fertility rate",xlab="Age", type = "l",mar=c(5, 5, 2, 2),cex.axis = 1.5, cex.lab = 1.7)
polygon(c(df$x,rev(df$x)),c(df$l,rev(df$u)),col = "yellow", border = FALSE)
lines(df$x, df$y, lwd = 2)
lines(df$x, df$u, col="blue",lty=2)
lines(df$x, df$l, col="blue",lty=2)
...
for (i in 1:20){ 
  ...
  df[is.na(df)]     = 0
  plot(df$x, df$y, ,ylim=c(0,0.5),main=substitute(paste(b,' (',a,"-step)"),list(a=i,b=1989+i)),ylab="Fertility rate",xlab="Age", type = "l")
  polygon(c(df$x,rev(df$x)),c(df$l,rev(df$u)),col = "yellow", border = FALSE)
  lines(df$x, df$y, lwd = 2)
  lines(df$x, df$u, col = "blue",lty=2)
  lines(df$x, df$l, col = "blue",lty=2)
